                    ...
                    children: <Widget>[
                      dataStore.updatedBill.isPaid
                          ? RaisedButton(
                              ...
                              onPressed: () async {
                                dataStore
                                    .markBillAsUnpaid(dataStore.updatedBill);
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              actions: [
                                ...
                                FlatButton(
                                  onPressed: () {
                                    Navigator.of(context).pop();
                                    dataStore.setTitle(dataStore.updatedBill,
                                        dataStore.newTitle);
                                  },
                                  child: Text("Save"),
                                ),
                          ...
                          showDialog(
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              content: TextField(
                                ...
                                controller: TextEditingController(
                                    text: dataStore.updatedBill.amount
                                        .toString()),
                                onChanged: (String value) {
                              ...
                              actions: [
                                ...
                                FlatButton(
                                  onPressed: () {
                                    Navigator.of(context).pop();
                                    dataStore.setAmount(dataStore.updatedBill,
                                        dataStore.newAmount);
                                  },
                                  child: Text("Save"),
                                ),
